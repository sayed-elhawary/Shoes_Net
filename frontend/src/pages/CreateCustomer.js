...
const CreateCustomer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // التحقق من أن رقم الهاتف 11 رقمًا
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="mb-4">
            <label className="block text-white text-sm mb-2 text-right">الاسم</label>
            <motion.input
              type="text"
              value={form.name}
          ...
          <div className="mb-4">
            <label className="block text-white text-sm mb-2 text-right">رقم الهاتف</label>
            <motion.input
              type="text"
              value={form.phone}
              ...
              required
              disabled={loading}
              placeholder="أدخل رقم الهاتف (11 رقمًا)"
              variants={inputVariants}
              whileHover="hover"
              whileFocus="focus"
            />
